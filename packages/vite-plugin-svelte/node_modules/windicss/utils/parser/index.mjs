        ...
        if (parentType === 'selector') {
            styles.forEach(function (i) {
                ...
                if (!i.selector) {
                    ...
                    if (!/&/.test(selector_1))
                        selector_1 = /\s*,\s*/.test(selector_1) ? selector_1.trim().split(/\s*,\s*/g).map(function (i) { return "& " + i; }).join(', ') : "& " + selector_1;
                ...
                if (this_1.processor) {
                    ...
                    if (directives_1) {
                        if ('atrule' in directives_1) {
                            ...
                            styleSheet.add(result.styleSheet.children.map(function (i) {
                                var _a;
                                if (!(i instanceof Keyframes)) {
